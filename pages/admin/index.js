        ...
        <div className="px-4 mt-6 sm:px-6 lg:px-8">
          ...
          <ul className="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 xl:grid-cols-4 mt-3">
            ...
            <BasicStats
              ...
              title="Unlabelled"
              subtitle={`${overviewData.unlabelled / overviewData.total * 100}% left`}
              bgClass="bg-coolGray-600"
            />
            <BasicStats
              data={overviewData.rejected}
              title="Rejected"
              subtitle={`${overviewData.rejected / overviewData.total * 100}% of applications`}
              bgClass="bg-red-600"
            />
            <BasicStats
              data={overviewData.accepted}
              title="Accepted"
              subtitle={`${overviewData.accepted / overviewData.total * 100}% of applications`}
